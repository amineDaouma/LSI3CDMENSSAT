...
public interface ProgramService 
{
	...
	//retourne le program lié au cmd identifié par idCDM
	//retourne null si le cdm n'est pas trouve
	
	Program updateProgram(String idCDM, Program newProgram);
	//remplace e program lié au cmd identifié par idCDM par newProgram
	...
	//remplace le Subprogram identifié par idCDM et idSubProgram par newSubProgram
	//retourne null si le cdm n'a pas ete trouve
