...
@Entity(name = "RefCourse")
@Table(name = "REFCOURSE")
@Inheritance(strategy = InheritanceType.JOINED)
public class RefCourse implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RefCourse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RefCourse that = ((RefCourse) object);
        {
            String lhsIdRef;
